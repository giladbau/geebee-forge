...
<div class="landing">
  ...
  <div class="grid">
    <article role="article" data-testid="demo-card" class="card">
      <h2 data-testid="card-title">Constellation</h2>
    ...
    <article role="article" data-testid="demo-card" class="card">
      ...
      <p class="card-desc">Israel rocket alert statistics dashboard.</p>
...
<style>
  ...
  .card:hover {
    ...
    box-shadow: 0 8px 32px rgba(74, 127, 255, 0.12);
  }
